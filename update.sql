...
INSERT INTO `testnote`.`users_logins` (`id`, `created`, `user_id`, `ip_id`, `os`, `browser_agent`) VALUES ('1', NOW(), '1', '1', 'window', 'Mozilla/5.0 (iPad; U; CPU OS 3_2_1 like Mac OS X; en-us) AppleWebKit/531.21.10 (KHTML, like Gecko) Mobile/7B405'), ('2', NOW(), '2', '1', 'MAC OS', 'Mozilla/5.0 (iPad; U; CPU OS 3_2_1 like Mac OS X; en-us) AppleWebKit/531.21.10 (KHTML, like Gecko) Mobile/7B405');
